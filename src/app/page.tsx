  ...
  return (
    <main className="min-h-screen p-8">
      ...
      <div className='xl:flex xl:justify-between xl:items-center gap-8'>
        <HomePageCommonContainer title="Tulevat kilpailut" href="/kilpailut" data={upcoming}/>
        <HomePageCommonContainer title="Viimeisimmät tulokset" href="/tulokset" data={upcoming}/>
      </div>
    </main>
  );
}
